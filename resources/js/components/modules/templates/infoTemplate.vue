  ...
  <div class="module-info mb-5">
    <div class="col-12">
      <div class="row mt-3">
        ...
        <info-photo class="col-12" v-for="(element, index) in current_slide(slideNumber).content.images"
          :key="index"
          :image="element"
          :imageCount="Object.keys(current_slide(slideNumber).content.images).length">
        </info-photo>
        <info-content class="col-12" v-for="(element, index) in current_slide(slideNumber).content.paragraph"
          :key="`${index}-${element.id}`"
          :paragraph="element"
          :icon="element.icon">
        </info-content>
        <div class="col-12" v-if="current_slide(slideNumber).content.list !== null">
