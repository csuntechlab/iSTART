<template>
  <div class="module-info mb-5">
    <div class="container">
      ...
      <div v-if="current_slide(slideNumber).format.images && current_slide(slideNumber).format.images ==='carousel'">
        <div id="carousel" class="carousel slide" data-ride="carousel">
          <div class="carousel-inner">
            <div :class="['module-info__carousel-item carousel-item', ( index === '0' ? 'active' : '' )]" v-for="(element, index) in current_slide(slideNumber).content.images" :key="index">
