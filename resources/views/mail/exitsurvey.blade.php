...
@section('content')
    ...
    <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0 0 15px;">
        ...
        @elseif($user->getUserGroup->user_group === 'comparison')
            Thank you. You have now completed the web module!
        @else
            Than you for being in the control group.
        @endif
        If you haven't done so already, please take the Exit survey now (it will take around 10 minutes).</p>
