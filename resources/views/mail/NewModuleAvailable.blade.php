...
@section('content')
    ...
    <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0 0 15px;">The following new module: <b>{{ ucfirst($NewModuleAvailable) }}</b> is available for completion.</p>
